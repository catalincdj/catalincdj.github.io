	...
	<div class="wrapper">
	   ...
	   <nav id="nav">
	    	...
	    	<ul>
				...
				<li style="background-color: #52528C; float: right;"><a href="register.php">Register</a></li>
				<li style="background-color: #52528C; float: right;"><a href="login.php">Log In</a></li>
			</ul>
		</nav>
	</div>
</header>
